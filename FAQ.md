...
### A1: ケーブルを奥まで挿しているかご確認ください。
奥まで刺さっている場合、下記の画像のようになります。
![image](https://github.com/user-attachments/assets/31c28144-4cbe-4502-9e0a-ec72a1e78a48)

### A2: 旧版REVIVE用の設定ツールを利用していないかご確認ください。
新REVIVE Type-Cの設定ツールを使用してください。

### A3: 「デバイスとプリンター」などで接続が確認できている場合、一度ドライバーを削除したのち再接続を行ってください。
...
### A: 以下の点を目視、あるいはテスターなどで確認してください
 ...
 - GND線が断線していないか
 - REVIVE Type-C本体が筐体やネジの金属部などに接触しショートしていないか
...
設定ツールからは1台のREVIVE USB Type-Cしか認識できません。  
複数のREVIVE USB Type-Cを接続し、PCを操作することは可能です。
